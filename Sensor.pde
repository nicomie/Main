...
class Radio {
    ...
    // AI Relevant code: The method generates the task announcement for the contract net protocol
...
class FOV {
    ...
    // AI Relevant code: The method is used by agents for problem recognition.
    void sense() {
        boolean found = false;
        int amount = 0;
        ...
        if (found) {
            in_range = true;
            if (!cooldown) {
                // AI Relevant code: Starts task announcement
